            ...
            {editor?.isActive('table') && (
              <>
                ...
                >
                  ...
                  >
                    <path fill='none' d='M0 0H24V24H0z' />
                    <path d='M20 13c.552 0 1 .448 1 1v6c0 .552-.448 1-1 1H4c-.552 0-1-.448-1-1v-6c0-.552.448-1 1-1h16zm0 2H4v4h16v-4zM3 3h18c.552 0 1 .448 1 1v6c0 .552-.448 1-1 1h-9v2h5v2H7v-2h5v-2H3c-.552 0-1-.448-1-1V4c0-.552.448-1 1-1zm1 2v4h16V5H4z' />
                  </svg>
                </button>
                <button
